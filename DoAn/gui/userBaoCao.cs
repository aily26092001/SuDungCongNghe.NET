        ...
        private void btnTK_Click(object sender, EventArgs e)
        {
            ...
            else if (radQuy.Checked)
            {
                if (cboQuy.SelectedItem.ToString().Equals("Quý 1"))
                {
                    ...
                    if (dataGridView_BC.Rows.Count > 0) //nếu có 1 hàng thì xuât ra
                    {
                        show_BC();
                        tinh_tong(dataGridView_BC.Rows.Count);
                    }
            ...
            {
                MessageBox.Show("Hãy chọn điều kiện để báo cáo", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
