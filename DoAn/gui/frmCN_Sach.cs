...
namespace DoAn.gui
{
    public partial class frmCN_Sach : Form
    {
        ...
        internal frmCN_Sach(ThongTinSach sach, ToolStripProgressBar progress, ToolStripLabel label, int id_role)
        {
            InitializeComponent();
            this.sach = sach;
        ...
        private void btnCapNhatThongTinSach_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Hãy nhập Giá bán là SỐ !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtGiaBan.Focus();
                txtGiaBan.SelectAll();
                return;
            }
            ...
            {
                if (MessageBox.Show("Giá bán đang là 0 ! Bạn có muốn cập nhật giá bán ?", "Thông báo",
            ...
            if (MessageBox.Show("Bạn có muốn cập nhật thông tin sách [ " + txtMaSach.Text + " ] không ?", "Thông báo",
            ...
            {
                progress_sc();
                MessageBox.Show("Sửa đổi thông tin sách KHÔNG thành công !", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                this.Hide();
            }
        }
